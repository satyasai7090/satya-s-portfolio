...
const About = () => {
  return <PageLayout>
      <PageHero label="About" title="How I Work" description="I specialize in creating clear, accurate, and user-focused documentation for complex enterprise software environments." />
        ...
        <div className="container-narrow">
          ...
          <AnimatedSection delay={0.1}>
            <div className="prose prose-lg">
              <motion.p className="body-default text-muted-foreground leading-relaxed mb-6" initial={{
              opacity: 0,
              y: 20
            }} whileInView={{
              opacity: 1,
      ...
      <section className="section-padding">
        <div className="container-narrow">
          ...
          <AnimatedContainer className="space-y-8" staggerDelay={0.15}>
            <AnimatedItem>
              <motion.div className="group card-elevated card-hover-glow border border-transparent cursor-pointer" whileHover={{
              y: -6,
      ...
      <section className="section-padding surface-accent">
        <div className="container-narrow">
          ...
          margin: "-50px"
            ...
            {["Reliability in complex, high-stakes environments", "Meticulous attention to accuracy and detail", "Strong ownership and accountability", "Experience mentoring junior writers", "Acting lead experience on documentation initiatives", "Recognition for documentation excellence"].map((item, index) => <motion.div key={index} variants={itemVariants} className="group flex items-start gap-3 p-4 hover-slide-right cursor-pointer" whileHover={{
            x: 6,
            scale: 1.02
          }} whileTap={{
            scale: 0.98
